				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<div class="shop-cat-box">
                            ...
                            <a class="btn hvr-hover" href="./shop.html">One Time Purchase</a>
                        </div>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<div class="shop-cat-box">
                            ...
                            <a class="btn hvr-hover" href="./choose-box.html">Subscription Box</a>
                        </div>
					</div>
				</div>
			</div>
            ...
            <div class="container">
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-top-box">
							<h3>Social Media</h3>
							<p>Follow us using the links below.</p>
							<ul>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><i class="fas fa-envelope"></i>Email: contact@cafecrate.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
