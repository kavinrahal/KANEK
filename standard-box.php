...
<head>
    ...
    <meta name="keywords" content="standard box, no diet, subscription, vegan, gluten free, standard, cafe, cafe crate, treat, goodies, sweets, cake, muffin, slice, cookie, pastry, monthly, australia, local">
    <meta name="description" content="Standard subscription box for Cafe Crate">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Standard Box </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100 rounded" src="images/standard.png" alt="First slide"> </div>
                        </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2 class = "item_name">Standard Box</h2>
						<h4>Short Description:</h4>
						<p>The standard box has everything you could ever want. Giving cafes complete freedom to package their best treats for your eating pleasure  </p>
						<p>Each box contains: 15 different goods from 3 cafes, a variety of snacks, no required dietary restrictions, a brochure telling you about each cafe</p>
						<ul>
							<li>
